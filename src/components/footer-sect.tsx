...
export function Footer({ data }: { data: data_to_show }) {
    ...
    return (
        <footer id="contacts" className="flex flex-col items-center gap-3 sm:self-center 
         ...
         text-center w-screen border-t-4 p-4 relative">
            <FooterCat />
            <h3 className="text-xl">Contact me</h3>
            <span className="text-surface-fg max-w-250 text-xs sm:text-sm">
...
export function FooterCat() {
    ...
    return (
        <div className="absolute -top-12 right-0 sm:right-1/6 flex flex-col items-center">
            <motion.svg
                viewBox="0 0 413.928 413.928"
                className="w-15 h-15 cursor-grab active:cursor-grabbing text-surface-muted-fg"
