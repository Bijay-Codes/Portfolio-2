...
//         hover:bg-primary hover:text-primary-fg hover:border-accent
//         transition-colors`;
...
//                 backdrop-blur-sm px-3 sm:py-1 flex items-center justify-between gap-4"
//             >
//                 <button
//                     type="button"
//                     className={navButton}
...
//                             onClick={() => setIndex(i)}
//                             className={`h-2 rounded-full transition-all ${i === index ? "w-4 bg-primary" : "w-2 bg-surface-muted-fg/40"
//                                 }`}
//                         />
//                     ))}
//                 </div>
